...
const VIABILITY_RANKINGS = {
    sm: {
        ...
        ou: {
            ...
            A: ["Greninja","Celesteela","Heatran","Magearna","Tapu Fini","Tapu Koko","Buzzwole","Charizard","Ferrothorn","Garchomp","Hoopa-Unbound","Magnezone","Manaphy","Pheromosa","Rotom-Wash","Scizor","Tapu Bulu","Venusaur","Zygarde","Alakazam","Amoonguss","Excadrill","Jirachi","Latios","Marowak-Alola","Nihilego","Pinsir","Sableye","Skarmory","Tornadus-Therian","Tyranitar","Weavile"],
            ...
            C: ["Alomomola","Azumarill","Crawdaunt","Diggersby","Klefki","Hippowdon","Mamoswine","Mimikyu","Muk-Alola","Minior","Necrozma","Nidoking","Ninetales-Alola","Shedinja","Whimsicott","Xurkitree","Azelf","Dragalge","Empoleon","Gastrodon","Kyurem","Magneton","Mandibuzz","Reuniclus","Shuckle","Smeargle","Thundurus-Therian","Absol","Bewear","Cofagrigus","Decidueye","Feraligatr","Hawlucha","Hydreigon","Kommo-o","Primarina","Seismitoad","Talonflame","Tentacruel","Torkoal","Victini"],
        },
        uu: {
            // from usage stats: top 5; >5%, >2%, >1%
            S: ["Scizor","Latias","Keldeo","Mandibuzz","Porygon-Z"],
            A: ["Bisharp","Hippowdon","Azumarill","Azelf","Terrakion","Aerodactyl","Forretress","Raikou","Zygarde","Gliscor","Primarina","Serperior","Starmie","Blastoise","Gengar","Tentacruel","Breloom","Slowbro","Volcarona","Krookodile","Thundurus","Necrozma","Mew","Blissey","Sharpedo","Gyarados","Tsareena","Tornadus-Therian","Decidueye","Dhelmise","Victini","Magneton"],
