...
const VIABILITY_RANKINGS = {
    xy: {
        ...
        ou: {
            ...
            S: ["Clefable"],
            A: ["Diancie","Heatran","Keldeo","Landorus-Therian","Latios","Rotom-Wash","Scizor","Tornadus-Therian","Tyranitar","Azumarill","Charizard","Excadrill","Ferrothorn","Garchomp","Jirachi","Lopunny","Manaphy","Medicham","Sableye","Slowbro","Talonflame","Thundurus","Volcanion","Weavile","Alakazam","Bisharp","Gardevoir","Gliscor","Heracross","Latias","Metagross","Pinsir","Serperior","Skarmory","Starmie","Tangrowth","Terrakion"],
            B: ["Amoonguss","Chansey","Gengar","Gyarados","Hippowdon","Kyurem-Black","Magnezone","Manectric","Mew","Nidoking","Suicune","Venusaur","Aerodactyl","Altaria","Breloom","Crawdaunt","Dragonite","Gastrodon","Kingdra","Klefki","Politoed","Quagsire","Reuniclus","Slowking","Volcarona","Alomomola","Celebi","Diggersby","Hydreigon","Kabutops","Mamoswine","Raikou","Togekiss","Zapdos"],
            C: ["Dragalge","Empoleon","Gallade","Infernape","Lucario","Mandibuzz","Omastar","Sceptile","Scolipede","Sharpedo","Swampert","Thundurus-Therian","Victini","Zygarde","Azelf","Dugtrio","Entei","Feraligatr","Hawlucha","Jellicent","Kyurem","Magneton","Pidgeot","Seismitoad","Tentacruel","Toxicroak","Aggron","Beedrill","Blastoise","Chesnaught","Cobalion","Cofagrigus","Conkeldurr","Goodra","Hoopa","Rotom-Heat","Staraptor"],
        },
        uu: {
            // http://www.smogon.com/forums/threads/oras-uu-viability-rankings-v5.3576945/
            S: ["Hydreigon","Aerodactyl","Celebi","Suicune"],
            A: ["Entei","Krookodile","Sylveon","Swampert","Gyarados","Beedrill","Mamoswine","Sceptile","Conkeldurr","Cobalion","Cresselia","Reuniclus","Sharpedo","Tentacruel","Empoleon","Nidoqueen","Crobat","Whimsicott","Sableye","Snorlax","Blastoise","Infernape","Heracross"],
            B: ["Crawdaunt","Kyurem","Alomomola","Tornadus","Lucario","Rotom-Mow","Metagross","Florges","Toxicroak","Azelf","Mienshao","Escavalier","Nidoking","Milotic","Feraligatr","Houndoom","Roserade","Haxorus","Chandelure","Froslass","Abomasnow","Absol","Aggron","Arcanine","Blissey","Bronzong","Chesnaught","Diancie","Doublade","Dragalge","Forretress","Gligar","Heliolisk","Jellicent","Machamp","Mandibuzz","Porygon2","Porygon-Z","Rotom-Heat","Shaymin","Slowking","Slurpuff","Tyrantrum","Venomoth","Ampharos","Cloyster","Darmanitan","Espeon","Galvantula","Gardevoir","Hoopa","Magneton","Shuckle","Steelix","Umbreon","Virizion"],
            C: ["Quagsire","Dugtrio","Fletchinder","Honchkrow","Kingdra","Meloetta","Qwilfish","Registeel","Seismitoad","Weezing","Uxie","Yanmega","Zoroark","Donphan","Aromatisse","Gastrodon","Goodra","Moltres","Noivern","Omastar","Pangoro","Rhyperior","Togetic","Accelgor","Druddigon","Glalie","Granbull","Hitmonlee","Shedinja","Venusaur"],
        },
        ru: {
        ...
        nu: {
            ...
            S: ["Jynx","Mesprit","Tauros"],
            A: ["Archeops","Garbodor","Lilligant","Magmortar","Pyroar","Rhydon","Rotom","Samurott","Shiftry","Swellow","Xatu","Audino","Barbaracle","Charizard","Hariyama","Hitmonchan","Kangaskhan","Lanturn","Scyther","Steelix","Vivillon","Weezing","Aurorus","Combusken","Gastrodon","Gurdurr","Kabutops","Ludicolo","Malamar","Mismagius","Musharna","Omastar","Skuntank"],
            B: ["Abomasnow","Aggron","Carracosta","Ferroseed","Floatzel","Gourgeist-Super","Haunter","Liepard","Piloswine","Pinsir","Regirock","Vileplume","Claydol","Golurk","Grumpig","Manectric","Mantine","Miltank","Pelipper","Poliwrath","Primeape","Sliggoo","Torterra","Zangoose","Articuno","Cacturne","Chatot","Clefairy","Electivire","Roselia","Smeargle","Trevenant"],
            C: ["Bouffalant","Bronzor","Camerupt","Exeggutor","Kecleon","Klinklang","Lapras","Mawile","Misdreavus","Mr. Mime","Ninetales","Prinplup","Raichu","Sawsbuck","Victreebel","Altaria","Beheeyem","Cradily","Drifblim","Duosion","Gogoat","Gorebyss","Gourgeist-Small","Jumpluff","Kadabra","Leafeon","Linoone","Regice","Rotom-Fan","Tangela","Vanilluxe","Cryogonal","Electrode","Fraxure","Hippopotas","Metang","Pawniard","Probopass","Relicanth","Rotom-Frost","Sandslash","Shedinja","Solrock","Simisage","Stoutland","Throh","Vigoroth"],
        },
        pu: {
            // http://www.smogon.com/forums/threads/pu-viability-rankings.3528743/
            S: ["Floatzel","Rotom-Frost"],
            A: ["Monferno","Cacturne","Leafeon","Mr. Mime","Golem","Grumpig","Stoutland","Roselia","Stunfisk","Zebstrika","Pawniard","Dodrio","Regice","Vullaby","Chatot","Relicanth","Mawile","Gourgeist-Super","Jumpluff","Metang","Simipour","Swanna","Simisage","Electrode","Audino","Kadabra","Politoed","Articuno","Muk","Arbok","Crustle","Cryogonal","Bouffalant","Raichu","Clefairy","Dusknoir","Quilladin"],
            B: ["Smeargle","Ursaring","Probopass","Tangela","Ninjask","Murkrow","Misdreavus","Rapidash","Drifblim","Pelipper","Altaria","Gabite","Duosion","Huntail","Simisear","Rotom-Fan","Beheeyem","Camerupt","Basculin","Fraxure","Gogoat","Golduck","Gorebyss","Gourgeist-Small","Hippopotas","Lapras","Leavanny","Lumineon","Mightyena","Ninetales","Prinplup","Purugly","Solrock","Armaldo","Chinchou","Electabuzz","Kingler","Klang","Sawsbuck","Seaking","Volbeat"],
